...
export default async function handler(req) {
  try {
    ...
    if (a.facebook_url)  socialChips.push(`<a class="soc soc-fb" href="${escapeHtml(normUrl(a.facebook_url))}" target="_blank" rel="noopener nofollow" aria-label="Facebook (nouvel onglet)">${SOCIAL_ICONS.facebook}<span>Facebook</span></a>`);
    if (a.instagram_url) socialChips.push(`<a class="soc soc-ig" href="${escapeHtml(normUrl(a.instagram_url))}" target="_blank" rel="noopener nofollow" aria-label="Instagram (nouvel onglet)">${SOCIAL_ICONS.instagram}<span>Instagram</span></a>`);
    if (a.linkedin_url)  socialChips.push(`<a class="soc soc-li" href="${escapeHtml(normUrl(a.linkedin_url))}" target="_blank" rel="noopener nofollow" aria-label="LinkedIn (nouvel onglet)">${SOCIAL_ICONS.linkedin}<span>LinkedIn</span></a>`);
